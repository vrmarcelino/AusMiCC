...
def add_isolate(in_df, in_cursor):
    ...
    for index, row in in_df.iterrows():
        ...
        query = "INSERT INTO isolate {} VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)".format(col_names).replace("'","`")
        val = (row['isolate_name'], sampleid_map[row['sample_name']],plateid_map[row['plate_name']],
           ...
           row['colony_color'],row['colony_margin'],row['colony_elevation'],row['colony_form'],row['colony_surface'],
